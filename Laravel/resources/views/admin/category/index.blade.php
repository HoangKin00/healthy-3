...
<div class="container">
    ...
    <hr>
    <form action="{{route('category.clear')}}" method="POST" id="formDeleteAll">
        @csrf @method('DELETE')
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <a href="{{route('category.destroy', $cat->id)}}" class="btn btn-danger btn-delete btn-single-delete"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
                @endforeach
