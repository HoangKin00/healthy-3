...
<div class="container">
    <div class="col-8">
        <div class="card card-info">
            ...
            <form class="form-horizontal" action="{{route('category.update', $cat->id)}}" method="POST">
                @csrf @method('PUT')
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail3" placeholder="Tên Danh Mục" name="name" value="{{$cat->name}}">
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                            ...
                            <input type="radio" name="status" id="input" value="0" {{ $cat->status == 0 ? 'checked' : ''}}>
                                <label class="form-check-label" for="inlineRadio1">Ẩn</label>
                            </div>
                            <div class="form-check">
                            <input type="radio" name="status" id="input" value="1" {{$cat->status == 1 ? 'checked' : ''}}>
